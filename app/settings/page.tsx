...
export default function SettingsPage() {
  ...
  if (!mounted || authLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-[#87CEEB] to-[#E0F4FF] flex items-center justify-center">
        <Loader2 className="w-8 h-8 animate-spin text-[#1a7f7f]" />
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#87CEEB] to-[#E0F4FF] pb-24">
      {/* Header */}
      <div className="sticky top-0 z-10 bg-gradient-to-b from-[#87CEEB] to-[#87CEEB]/80 backdrop-blur-sm">
